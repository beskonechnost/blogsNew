INSERT INTO users (ID, ENABLED, username, password, role) VALUES (1, true , 'admin', '$2a$10$gQv4NjC4QoN1SzQoG1602eUm.yBzsvzqxMkDg2kLlgrsxM4JX.5TS', 'PUBLISHER');
INSERT INTO users (ID, ENABLED, username, password, role) VALUES (2, true , 'user', '$2a$10$umXMnGcZsVbWlOGA6ZYPSOZAtoYPvdbHU/bICiSUPdmpbQq9O99Yq', 'PUBLISHER');
INSERT INTO users (ID, ENABLED, username, password, role) VALUES (3, true , 'userTest', '$2a$10$HvOSK1Z/ZXa9DlKADf.EYOy68xCMZolzWW8/P1KizgtKmVWdPm65m', 'PUBLISHER');
